...
if(isset($_POST['submit'])) {
    ...
    $query=mysqli_query($con,"SELECT * FROM students WHERE StudentRegno='$regno' and password='$password'");    $num=mysqli_num_rows($query);
    if($num>0) 
    {
        ...
        $_SESSION['errmsg'] = "Invalid Regno or Password";
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <hr/>
                        <button type="submit" name="submit" class="btn btn-info"><span classs="glyphicon glyphicon-user"></span> &nbsp;Log Me In </button>&nbsp;
